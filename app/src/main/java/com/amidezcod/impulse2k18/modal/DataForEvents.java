    ...
    public static CardPagerAdapter enterData(CardPagerAdapter mCardAdapter) {
        ...
        mCardAdapter.addCardItem(
                new CardItem(R.drawable.game, "#Gaming", "Gamers don't fear the Apocalypse", new EventDetailsInfo(
                        ...
                        "\t\t>>  Final round will be a circuit of 3 laps.\n" +
                        "\t\t>>  Entry Fee: Rs. 100/- per team.", "Refer the game rule", "Attractive cash prize", "SPDP lab (new building 3rd floor), lab 1 (old building 3rd floor).",
                        new String[]{"Rakshith Patil +918861323937", "Amit Debnath +917259643271."}
                )));

        mCardAdapter.addCardItem(new CardItem(R.drawable.kannada, "#NammaBhaseKannada", "ನಂಬಿಕೆ ನಮ್ಮ ಭಾಷೆಯಲ್ಲಿ, ಹೆಮ್ಮೆ ನಮ್ಮ ಆತ್ಮದಲ್ಲಿ.", new EventDetailsInfo("Kannadiga is a platform for the participants to showcase their knowledge, talent and love towards the respectful language “Kannada”. The main purpose of this event is to make people understand history, culture, values and recent developments of the state “Karnataka”.\n" +
                "\nThe participants will be asked questions in the various fields like art, literature, sports, music and many more. This will check the presence of mind and their level of knowledge about the state and the language."
                , ">>  Each team consists of 2 members.\n" +
                ">>  Event consists of 5 rounds.\n" +
                ">>  Gadgets are not allowed.\n" +
                ">>  Judges decision will be final.", "100/- per team", "Attractive cash prizes", "Seminar Hall (new building 6th floor).",
        ...
        mCardAdapter.addCardItem(
                new CardItem(R.drawable.star, "#StarOfImpulse", "It's the will.\nNot the Skill", new EventDetailsInfo(
                        "This event is to showcase your talent by testing your wits and strengths. Do you have what it takes to play the game of thrones?",
                        ...
                        "50/- per person", "Attractive cash prize", "T.O.C.E", new String[]{"Sijo +918553794976", "Arjun +917406232268"}
                )));


        mCardAdapter.addCardItem(
                new CardItem(R.drawable.hot_wheels, "#HotWheels", "BUILD, RACE and Win", new EventDetailsInfo("An event in which you prepare your own mini hot wheels using raw materials provided and then racing it on the track for the best time lap.",
                        ">>  Model build should meet the provided dimensions\n" +
                                ...
                                ">>  The decisions made by the judges will be final.", "150/- per team",
                        "Attractive cash prize", "No Venue", new String[]{"harisree .v +919481453996", "prathap singh +919886061125"})));
        ...
        mCardAdapter.addCardItem(new CardItem(R.drawable.oxford_roadies, "#OxfordRoadies", "Think act and win", new EventDetailsInfo(
                ...
                "150/- per team", "Attractive cash prize", "Toce",
        ...
        mCardAdapter.addCardItem(
                new CardItem(R.drawable.mock_press, "#MockPress", "ಪ್ರತಿಬಿಂಬ", new EventDetailsInfo(
                        ...
                        , "100/- per team", "Attractive cash prize", "T.O.C.E",
        ...
        mCardAdapter.addCardItem(
                new CardItem(R.drawable.unknownit, "#Un-KnowIT", "Unlocking Knowledge at the speed of thought", new EventDetailsInfo(
                        ...
                        , "100/- per team", "Attractive cash prize", "T.O.C.E", new String[]{
        ...
        mCardAdapter.addCardItem(
                new CardItem(R.drawable.devil, "#DevilSegue", "The Eyes are useless when The Mind is blind", new EventDetailsInfo(
                        ...
                        "150/- per team", "Attractive cash prize", "T.O.C.E",
                        new String[]{
        ...
        mCardAdapter.addCardItem(
                new CardItem(R.drawable.robot, "#Roboventure", "The greater the obstacle The more fun to Win",
                        new EventDetailsInfo(
                                ...
                                "200/- per team", "Attractive cash prize", "T.O.C.E", new String[]{
                                "Madhan +918867797029",
        ...
        mCardAdapter.addCardItem(new CardItem(
                ...
                ">> Decision of the judge must be respected and is FINAL", "50/- per person", "Attractive cah prize", "T.O.C.E",
        ...
        mCardAdapter.addCardItem(new CardItem(
                ...
                "50/- per person", "Attractive cash prizes", "T.O.C.E", new String[]{
        ...
        mCardAdapter.addCardItem(new CardItem(
                ...
                "ROLL CAMERA ACTION is a short film making event which aims to recognize and reward the talent of the people who know how to express their ideas in their production. With the belief that cinematic story telling can make a difference in our world ,the ROLL Camera action of IMPULSE 2K18 is dedicated to shining a spotlight on films that make a difference  “If you and create memorable charters, demonstrate a unique world view, and use the visual medium of film to demonstrate your personal connection to an intriguing, unpredictable situation, you’ll create a short film that everyone wants to see.",
                ">> A team comprises of maximum of 5 members.\n" +
                        ">> Each team should present their short thins on the given genre.\n" +
                        ...
                        ">> Duration of the short film should not be less than 5 minutes and more than 1.0 minutes. \n" +
                        ...
                        ">> Out of the selected movies the Jury will select the top 30 films and cash prizes will be awarded and decisions of the Juries will be final."
                , "250/- per team", "Attractive cash prize", "Dummy", new String[]{
                "Manoj +918050402005",
                "Ashwin +919035811476"})));
        mCardAdapter.addCardItem(new CardItem(R.drawable.technovation, "#Technovation", "Our biggest problem is that we assume someone else wiil do ", new EventDetailsInfo(
                ...
                "50/- per person", "Attractive cash prize", "Dummy", new String[]{
        ...
        mCardAdapter.addCardItem(new CardItem(
                ...
                new EventDetailsInfo("This is an obstracle race.The race will be held between 2 participants at a time.Winners will advance to the next round and the one who doesn't qualify will get another chance to race.",
                        ...
                        "1000/- per team", "Attractive cash prize", "T.O.C.E",
                        new String[]{
                                "Shiva +919108167617",
                                "Sanjay +918050680289"})));
        mCardAdapter.addCardItem(new CardItem(
                R.drawable.techno_opous, "#Techno-Opous", "Do it in 8", new EventDetailsInfo(
                "The event is based on IOT(Internet of things).The participants are allowed to make the projects on \n" +
                        "\t\t\n>> Home Automation\n\n" +
                        "\t\t\t(or)\n\n" +
                        "\t\t>> Safety and Security"
                , ">> All the paricipants have to bring the raw materials and components on their own and begin the project in the college campus.\n" +
                ...
                ">> Timings: 9am to 4pm\n" +
                ">> The paticipants must assemble at the venue by 8:45 am\n" +
